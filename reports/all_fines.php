...
<div class="" style="padding: 10px;">
  ...
  <div class="">
    <!-- <div class="">
      <span>Табличная версия</span>
      <span>Графическая версия</span>
    </div> -->
    <div>
      <?
         ...
         if(($tarif=='free')||($tarif!=0)) {
          ...
          if ($n_new_blank_data > 0) {
              ...
              for ($i = 0; $i < $n_new_blank_data; $i++) {
                  ...
                  ?>
                  <div class="" style="border-bottom: 1px solid rgba(255,255,255,.1);"></div>
                  <div class="str_to_excell" name="<?=$new_blank_data_id;?>" style="border-right: 1px solid rgba(255,255,255,.1); border-bottom: 1px solid rgba(255,255,255,.1);">
                    <div class="tdcell" style="width: 80px;">
                      <?=$new_blank_data_dat;?>
                    </div>
                    <div class="tdcell">
...
<?
// Берем все номера СТС пользователя

//  Берем все штрафы пользователя

// Групперуем по транспортным средствам
