...
<table id="tblselect">
  ...
  <tr>
    <td>
      <input type="radio" name="selsrch" id="selnalog">
    </td>
    <td></td>
    <td><label for="selnalog">Искать налоги</label></td>
  </tr>
</table>
<br>
...
<table id="tblshtraf">
  <tr>
    <td>Номер ВУ</td>
    <td>
	<input type="text" id="vu" size="12" maxlength="12">
    </td>
  </tr>
  <tr>
    <td>Номер СТС</td>
...
<table id="tblnalog">
  <tr>
    <td>ИНН</td>
    <td>
	<input type="text" id="inn" size="12" maxlength="12">
    </td>
  </tr>
  <tr>
    <td>СНИЛС</td>
    <td>
      <input type="text" id="snils" size="12" maxlength="12">
    </td>
  </tr>
  <tr>
    <td>или</td>
  ...
  <tr>
    <td>
	Номер налогового документа</td>
    <td>
      <input type="text" id="ind" size="22" maxlength="25">
    </td>
  </tr>
</table>
<br>
<button id="buttsearch">Поиск >></button>
...
{   if(intID!=0) { clearTimeout(intID); intID=0; }
    ...
    $('#buttsearch').on('click',function(){
		...
		if(type=="<?echo _ZKZ_SHTRAF;?>"&&!fldArr['vu']&&!fldArr['sts']&&!fldArr['ps']) {
  		...
  		if(type=="<?echo _ZKZ_NALOG;?>"&&!fldArr['inn']&&!fldArr['snils']&&!fldArr['ind']) {
            msgstr.html("Введите номер ИНН и/или СНИЛС или номер Налогового документа<br>");
		}
		else {
